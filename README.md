# This is a fork of commit 62f98ed from the official https://github.com/pollockjj/ComfyUI-MultiGPU that fixes the "too many values to unpack (expected 4)" error in WAN 2.2 workflows.
This repo will not actively be maintained so don't report issues. It is a fork of the original 62f98ed commit with the distorch_2.py script replaced by the patched version by https://github.com/katzsmile  

### IMPORTANT: Do not attempt to run a clone of this repo in parallel with one from the original developer as they will conflict.  

---

# ComfyUI-MultiGPU v2: Universal .safetensors and GGUF Multi-GPU Distribution with DisTorch
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-MultiGPU-Patched/main/assets/distorch_average.png" width="600">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-MultiGPU-Patched/main/assets/distorch2_0.gif" width="800">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-MultiGPU-Patched/main/assets/distorch_node.png" width="400">
  <br>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Fossiel/ComfyUI-MultiGPU-Patched/main/assets/distorch2_0.png" width="300">
  <br>
...
Clone [this repository](https://github.com/Fossiel/ComfyUI-MultiGPU-Patched) inside `ComfyUI/custom_nodes/`.
